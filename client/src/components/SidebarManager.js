  ...
  <div className="sidebar">
    <div className="sidebar-content">
      <nav className="sidebar-nav">
        ...
        <NavLink to="/register-user" className="nav-item" activeClassName="active-nav-item">
        ...
        <NavLink to="/reports" className="nav-item" activeClassName="active-nav-item">
          <span className="nav-icon"><FontAwesomeIcon icon={faFileInvoiceDollar} /></span>
          <span className="nav-text">Reports</span>
        </NavLink>

        <NavLink to="/manage-properties" className="nav-item" activeClassName="active-nav-item">
          <span className="nav-icon"><FontAwesomeIcon icon={faBuilding} /></span>
          <span className="nav-text">Property Management</span>
        </NavLink>

        <NavLink to="/units/manage" className="nav-item" activeClassName="active-nav-item">
          <span className="nav-icon"><FontAwesomeIcon icon={faCubes} /></span>
          <span className="nav-text">Unit Management</span>
        </NavLink>

        <NavLink to="/booking-management" className="nav-item" activeClassName="active-nav-item">
